...
export default function BuscarPage() {
  ...
  useEffect(() => {
    getAllProducts().then((all) => {
      ...
      if (!termo) { setResults(all); return; }
      setResults(
        all.filter((p) =>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6">
          ...
          {results === null ? (
            ...
            <div className="flex flex-col items-center justify-center py-16 gap-3 text-center">
              <p className="text-gray-700 font-medium">Nenhum anúncio encontrado</p>
              <p className="text-sm text-gray-400">Tente pesquisar por outro termo.</p>
              <Link href="/" className="mt-2 text-sm text-primary-700 hover:underline">
